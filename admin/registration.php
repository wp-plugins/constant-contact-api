...
?>
	...
	<tr valign="top">
		...
		<td>
		<p><label for="cc_list_selection_format_checkbox" class="howto"><input <?php echo (get_option('cc_list_selection_format')=='checkbox') ? 'checked="checked"':''; ?> type="radio" id="cc_list_selection_format_checkbox" name="cc_list_selection_format" value="checkbox" /> <span>Checkboxes</span></label>
		...
		<label for="cc_list_selection_format_dropdown" class="howto"><input <?php echo (get_option('cc_list_selection_format')=='select') ? 'checked="checked"':''; ?> type="radio" id="cc_list_selection_format_dropdown" name="cc_list_selection_format" value="dropdown" /> <span>Dropdown List</span></label></p>
		<p class="description">
