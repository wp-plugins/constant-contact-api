	...
	<table class="post fixed widefat" cellspacing="0">
			<thead>
				<tr>
					...
					<th scope="col" id="eventid" class="manage-column column-id" style="">Shortcode <span class="help cc_qtip" title="Use the ID inside the [eventspot] shortcode to display a single event in your post or page content; for example: [eventspot id='abc1244']" style="display:inline-block; background: url(<?php echo str_replace('/admin/', '/', plugin_dir_url(__FILE__)).'images/help.png'; ?>) left top no-repeat; width:16px; height:16px; overflow:hidden; text-indent:-99999px; text-align:left;">What is this for?</span></th>
