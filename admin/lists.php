				...
				<?php
					...
					<tr class="<?php echo $alt; ?>">
						<td class="column-title post-title page-title">
							<strong><?php if($v['id'] != '1') {?><a href="<?php echo add_query_arg(array('edit'=>$v['id']), remove_query_arg(array('add', 'edit', 'delete', 'refresh'))); ?>" class="row-title"><?php echo $v['Name']; ?></a><?php } else { echo $v['Name']; }?></strong>
							<div class="row-actions">
							<?php if($v['id'] != '1') {?>
								<span class="edit"><a href="<?php echo add_query_arg(array('edit'=>$v['id']), remove_query_arg(array('add', 'edit', 'delete', 'refresh'))); ?>" title="Edit this item">Edit</a> | <a href="<?php echo add_query_arg(array('view'=>$v['id']), remove_query_arg(array('add', 'edit', 'delete', 'refresh'))); ?>" title="View this lists' contacts">View Contacts</a></span>
