					...
					<tr class="<?php echo $alt; ?>">
						<td class="column-title post-title page-title">
							...
							<div class="row-actions">
								<span class="edit"><a href="<?php echo add_query_arg(array('edit'=>$v['id']), remove_query_arg(array('add', 'edit', 'delete', 'refresh'))); ?>" title="Edit this item">Edit</a> | <a href="<?php echo add_query_arg(array('view'=>$v['id']), remove_query_arg(array('add', 'edit', 'delete', 'refresh'))); ?>" title="View this lists' contacts">View Contacts</a> | </span><span class="trash"><a onclick="return confirm('Really delete this contact list?');" href="<?php echo add_query_arg(array('delete'=>$v['id']), remove_query_arg(array('add', 'edit', 'delete', 'refresh'))); ?>" class="submitdelete">Delete</a></div>
						</td>
						<td class="column-id">
							<?php echo $v['id']; ?>
						</td>
