...
$("#paddingwidth,.input input[name=widthtype],#width").bind('change keyup', function(e) { 
	...
	function generateForm(textOnly, $changed) {
		...
		var dataString = 'rand='+ScriptParams.rand+'&'+formFields+'&'+styleFields+textOnlyLink+changedLink+'&path='+ScriptParams.path+'&text='+JSON.stringify(ScriptParams.text); //+'&action=cc_get_form
