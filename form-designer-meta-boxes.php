...
?>
	...
	<div class="block">
		<label for="pupt" class="checkbox howto"><input type="checkbox" name="pupt" id="pupt" <?php check_checkbox($form, 'pupt', 'yes', false); ?> /> <span><?php _e('Update label &amp; placeholder text.', 'constant-contact-api'); ?></span>
	...
	<label class="howto block"><span>SafeSubscribe</span></label>
		<ul>
				  	<li><label for="safesubscribelight"><input type="radio" <?php check_radio($form,'safesubscribe', 'light', true); ?> name="safesubscribe" id="safesubscribelight" /> <img src="<?php echo CC_FORM_GEN_PATH; ?>images/safesubscribe-light.gif" alt="SafeSubscribe Light" width="168" height="14" id="safesubscribelightimg" title="<?php _e('Gray', 'constant-contact-api'); ?>"/></label></li>
				  	<li><label for="safesubscribedark"><input type="radio" <?php check_radio($form,'safesubscribe', 'dark'); ?> name="safesubscribe" id="safesubscribedark" /> <img src="<?php echo CC_FORM_GEN_PATH; ?>images/safesubscribe-dark.gif" alt="SafeSubscribe Dark" width="168" height="14" id="safesubscribedarkimg" title="<?php _e('White', 'constant-contact-api'); ?>"/></label></li>
				  	<li><label for="safesubscribeblack"><input type="radio" <?php check_radio($form,'safesubscribe', 'black'); ?> name="safesubscribe" id="safesubscribeblack" /> <img src="<?php echo CC_FORM_GEN_PATH; ?>images/safesubscribe-black.gif" alt="SafeSubscribe Black" width="168" height="14" id="safesubscribeblackimg" title="<?php _e('Black', 'constant-contact-api'); ?>"/></label></li>
				  	<li><label for="safesubscribeno"><input type="radio" <?php check_radio($form,'safesubscribe', 'no'); ?> name="safesubscribe" id="safesubscribeno" /> <?php _e('Do Not Display', 'constant-contact-api'); ?></label></li>
	</div>
<?php
}
...
<fieldset>
			...
			<fieldset>
				...
				<select id="lpad" name="lpad">
				  ...
				  <option<?php check_select($form,'lpad', '.75', true); ?> value=".75">.75 em</option>
				  <option<?php check_select($form,'lpad', '1'); ?> value="1">1 em</option>
				  ...
				  <option<?php check_select($form,'lpad', '2'); ?> value="2">2 em</option>
